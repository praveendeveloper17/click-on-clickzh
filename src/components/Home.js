      ...
      <Row className="align-items-center">
        <Col xs={12} md={12} lg={12}>
          <div className="home-content">
            ...
            <Container className="text-center py-5 card-icon">
              <Row>
                <Col xs={3} sm={3} md={3} lg={3} >
                  <button onClick={sendMessage} className='btn-clic'>
      ...
      <Container className="py-5">
        <Row className="d-flex align-items-center">
          ...
          <Col xs={12} sm={6} className="text-center text-sm-start">
            <img
              src="maginaimag-2.jpg"
              alt="this owner img"
              className="img-fluid magina"
            />
          ...
          <Col xs={12} sm={6} className="text-center text-sm-start">
          <h1>manoj kumar</h1>
            <h2>Click N Clickz Photography Studio</h2>
            <div className=''>
            <h3><i class="fa-solid fa-square-phone"></i>7200006047-9500306047</h3>
            </div>
            <h2 className='open-time'>Open <span>until10:00pm</span></h2> 
           <a href='https://www.google.com/maps/place/Pannimadai+Rd,+Coimbatore,+Tamil+Nadu/@11.0853,76.9299,17z/data=!4m6!3m5!1s0x3ba8f6717929877d:0x7ff6ce5bfa3d1318!8m2!3d11.0785307!4d76.915304!16s%2Fg%2F11h0vrxcz?hl=en&entry=ttu&g_ep=EgoyMDI0MTEyNC4xIKXMDSoASAFQAw%3D%3D'><h1><i class="fa-solid fa-location-dot location"></i>pannimadi-coimbatore</h1></a>
